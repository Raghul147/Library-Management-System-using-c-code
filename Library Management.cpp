...
{
  string line;
     cout<<"Details of issued books\n";
     cout<<"USN\t"<<"NAME\t"<<"B_NAME\t"<<"DATE\n";
     fstream fp;
     fp.open("bookissue.txt");
     while(!fp.eof())
       {
           getline(fp,line);
           cout<<line;cout<<"\n";
...
cout << "\nStudent usn :\n";
    ...
    cout<<"\n Return the book within 15 days";
...
fstream file;
 ...
 void book::display_b_record()
 {
     ...
     cout<<"book details\n";
     cout<<"B_NAME\t"<<"B_AUTHOR\t"<<"B_PUBLISHER\n";
...
/*------------------Main()----*/
 ...
 int main()
 {
  ...
  case 1: l.insert();
                ...
                break;
        case 2: l.display_n_record();
                break;
        case 3:{ cout<<"Enter librarian ID :";
                cin>>key;
                l.remove(key);
                cout<<"Updated file is :\n";
  ...
  int b_ch;
  cout<<"-----------------------** BOOK **---------------------------\n";
  cout<<"\n1. Add books \t\t\t2.Remove book Record\t\t3. Display book records\t\t\n\n\t\t\t(0) <<-- BACK\n";
  cout<<"--------------------------------------------------------------------\n";
  cout<<"\nEnter your choice\n";
  cin>>b_ch;
  switch(b_ch)
